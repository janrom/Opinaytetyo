(function (engine)
{
    ...
    engine.assets.Border = function (asset, interpreter)
    {
        ...
        cssid = asset.getAttribute("cssid") || "WseBorder" + id;
        engine.tools.applyAssetUnits(this, asset);
        
        el = document.createElement("div");
        
        el.setAttribute("id", cssid);
        el.setAttribute("class", "WseBorder");
        ...
        // the Border should only be visible when the show command
    ...
    engine.assets.Border.prototype.save = function ()
    {
    ...
    engine.assets.Border.prototype.restore = function (obj)
    {
    ...
    engine.tools.mixin(engine.assets.mixins.displayable, engine.assets.Border.prototype);
}(WSE));